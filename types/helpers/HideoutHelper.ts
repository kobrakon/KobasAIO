...
export class HideoutHelper
{
    ...
    protected getBTCSlots(pmcData: IPmcData): number
    {
        ...
        const hasManagementSkillSlots = this.hasManagementSkillSlots(pmcData);
        const managementSlots = this.getManagementSkillsSlots() || 2;

        return productionSlots + (hasManagementSkillSlots ? managementSlots : 0);
    }
    ...
    {
        return this.getHideoutManagementSkill(pmcData)?.Progress >= 5100;
    }
